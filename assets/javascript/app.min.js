...
return!0}}
class BancodeDados{constructor(){let idAluno=localStorage.getItem('idAluno');let idProfessor=localStorage.getItem('idProfessor');if(idAluno===null){localStorage.setItem('idAluno',0)}
...
reserva.id=i;reservas.push(reserva)}
return reservas}
recuperaFuncionario(){let funcionarios=Array();let id=localStorage.getItem("idFuncionario");for(let i=0;i<=id;i++){let funcionario=JSON.parse(localStorage.getItem(i));if(funcionario===null){continue}
...
return reservasFiltradas}else if(nome=="Aluno"){let reservasFiltradas=Array();reservasFiltradas=this.recuperaReservaAluno();if(reserva.nome!=""){reservasFiltradas=reservasFiltradas.filter(a=>a.nome==reserva.nome)}
...
versaoApp(){let versao=localStorage.getItem("versao");if(versao===null||versao==="1.5.0-beta"){localStorage.setItem("versao","1.6.0-beta")}}
...
let horaB=document.getElementById('horaB');let horaC="00:00:00";let horaD="00:00:00";reserva=new ReservaProfessor(nome.value,equipamento.value,status,sala.value,dataA.value,horaA.value,dataB,horaB.value,horaC,horaD);if(reserva.validarDados()){bancodedados.gravar(reserva,"Professor");modalCadastar(reserva.nome,tabelaProfessorA("success",reserva.equipamento,reserva.sala,dataBR(reserva.dataA),reserva.horaA,reserva.horaB),"professor");nome.value="";equipamento.value="";sala.value="";dataA.value="";horaA.value="";horaB.value=""}
else{modalCadastrarErro()}}
function cadastrarReservaAluno(){let nome=document.getElementById('aluno');let equipamento=document.getElementById('equipamento');let matricula=document.getElementById('matricula');let serial=document.getElementById('serial');let dataA=document.getElementById('dataA');let horaA=document.getElementById('horaA');let status=null;let horaB=null;let dataB=null;let horaC="00:00:00";if(horaA.value==horaAtualB(0,0)&&dataA.value==dataAtual()){status="Em uso";horaA=horaAtual(0,0,0);horaB=horaAtual(0,0,0);dataA=dataAtual();dataB=dataAtual()}
else{status="Aguardando";horaA=document.getElementById('horaA').value;horaA=horaA+":00";horaB="00:00:00";dataA=document.getElementById('dataA').value;dataB="0000-00-00"}
reserva=new ReservaAluno(nome.value,equipamento.value,status,matricula.value,serial.value,dataA,horaA,dataB,horaB,horaC);if(reserva.validarDados()){bancodedados.gravar(reserva,"Aluno");modalCadastar(reserva.nome,tabelaAlunoA("success",reserva.matricula,reserva.equipamento,reserva.serial,dataBR(reserva.dataA),reserva.horaA),"aluno");nome.value="";matricula.value="";equipamento.value="";serial.value="";horaA.value="";dataA.value=""}else{modalCadastrarErro()}}
function cadastrarFuncionario(){let id=localStorage.getItem("idFuncionario");let dataA=dataAtual();let horaA=horaAtual(0,0,0);bancodedados.versaoApp();let versao=bancodedados.retornaVersao();if(id===null){let nome=prompt("Antes de começarmos informe o seu nome");let funcionario=new Funcionario(nome,dataA,horaA,versao);if(funcionario.validarFuncionario()){bancodedados.gravarFuncionario(funcionario);modalCadastarFuncionario(funcionario.nome)}
else{modalErro();window.location.reload()}}}
function ListaReservasProfessores(){cadastrarFuncionario();relogio();alertaP();alertaA();let funcionario=Array();funcionario=bancodedados.recuperaFuncionario();funcionario.forEach(function(f){document.getElementById("funcionario").innerHTML=f.nome})
let reservas=Array();reservas=bancodedados.recuperaReservaProfessor();let listaReservas=document.getElementById("listaProfessores");reservas.forEach(function(p){let linha=listaReservas.insertRow();linha.insertCell(0).innerHTML=p.nome;linha.insertCell(1).innerHTML=p.equipamento;linha.insertCell(2).innerHTML=p.sala;linha.insertCell(3).innerHTML=cor(p.status);linha.insertCell(4).append(botaoVizualizarProfessor(p.id,p.nome,p.equipamento,p.status,p.sala,p.dataA,p.horaA,p.dataB,p.horaB,p.horaC,p.horaD)," ",botaoEditarProfessor(p.id,p.nome,p.equipamento,p.status,p.sala,p.dataA,p.horaA,p.dataB,p.horaB,p.horaC,p.horaD)," ",botaoExcluirProfessor(p.id,p.nome,p.equipamento,p.status,p.sala,p.dataA,p.horaA,p.dataB,p.horaB,p.horaC,p.horaD)," ",botaoVerificarProfessor(p.id,p.nome,p.equipamento,p.status,p.sala,p.dataA,p.horaA,p.dataB,p.horaB,p.horaC,p.horaD))})}
...
else{let reserva=new ReservaProfessor(nome,equipamento,status,sala,dataA,horaA,dataB,horaB);let reservas=bancodedados.pesquisaReserva(reserva,"Professor");let listaReservas=document.getElementById("listaProfessores");listaReservas.innerHTML="";reservas.forEach(function(p){let linha=listaReservas.insertRow();linha.insertCell(0).innerHTML=p.nome;linha.insertCell(1).innerHTML=p.equipamento;linha.insertCell(2).innerHTML=p.sala;linha.insertCell(3).innerHTML=cor(p.status);linha.insertCell(4).append(botaoVizualizarProfessor(p.id,p.nome,p.equipamento,p.status,p.sala,p.dataA,p.horaA,p.dataB,p.horaB,p.horaC,p.horaD)," ",botaoEditarProfessor(p.id,p.nome,p.equipamento,p.status,p.sala,p.dataA,p.horaA,p.dataB,p.horaB,p.horaC,p.horaD)," ",botaoExcluirProfessor(p.id,p.nome,p.equipamento,p.status,p.sala,p.dataA,p.horaA,p.dataB,p.horaB,p.horaC,p.horaD)," ",botaoVerificarProfessor(p.id,p.nome,p.equipamento,p.status,p.sala,p.dataA,p.horaA,p.dataB,p.horaB,p.horaC,p.horaD))})}}
function ListasReservasAlunos(){cadastrarFuncionario();relogio();alertaP();alertaA();let funcionario=Array();funcionario=bancodedados.recuperaFuncionario();funcionario.forEach(function(f){document.getElementById("funcionario").innerHTML=f.nome})
let reservas=Array();reservas=bancodedados.recuperaReservaAluno();let listaReservas=document.getElementById("listaAlunos");reservas.forEach(function(a){let linha=listaReservas.insertRow();linha.insertCell(0).innerHTML=a.nome;linha.insertCell(1).innerHTML=a.matricula;linha.insertCell(2).innerHTML=a.equipamento;linha.insertCell(3).innerHTML=a.serial;linha.insertCell(4).innerHTML=cor(a.status);linha.insertCell(5).append(botaoVizualizarAluno(a.id,a.nome,a.equipamento,a.status,a.matricula,a.serial,a.dataA,a.horaA,a.dataB,a.horaB,a.horaC)," ",botaoEditarAluno(a.id,a.nome,a.equipamento,a.status,a.matricula,a.serial,a.dataA,a.horaA,a.dataB,a.horaB,a.horaC)," ",botaoExcluirAluno(a.id,a.nome,a.equipamento,a.status,a.matricula,a.serial,a.dataA,a.horaA,a.dataB,a.horaB,a.horaC)," ",botaoVerificarAluno(a.id,a.nome,a.equipamento,a.status,a.matricula,a.serial,a.dataA,a.horaA,a.dataB,a.horaB,a.horaC))})}
function pesquisarReservaAluno(){let nome=document.getElementById('aluno').value;let equipamento=document.getElementById('equipamento').value;let matricula=document.getElementById('matricula').value;let serial=document.getElementById('serial').value;let dataA=document.getElementById('dataA').value;let horaA=document.getElementById('horaA').value;if(nome==""&&equipamento==""&&matricula==""&&serial==""&&dataA==""&&horaA==""){modalPesquisarErro()}
else{reserva=new ReservaAluno(nome,equipamento,"",matricula,serial,dataA,horaA);let reservas=bancodedados.pesquisaReserva(reserva,"Aluno");let listaReservas=document.getElementById("listaAlunos");listaReservas.innerHTML="";reservas.forEach(function(a){let linha=listaReservas.insertRow();linha.insertCell(0).innerHTML=a.nome;linha.insertCell(1).innerHTML=a.matricula;linha.insertCell(2).innerHTML=a.equipamento;linha.insertCell(3).innerHTML=a.serial;linha.insertCell(4).innerHTML=cor(a.status);linha.insertCell(5).append(botaoVizualizarAluno(a.id,a.nome,a.equipamento,a.status,a.matricula,a.serial,a.dataA,a.horaA,a.dataB,a.horaB,a.horaC)," ",botaoEditarAluno(a.id,a.nome,a.equipamento,a.status,a.matricula,a.serial,a.dataA,a.horaA,a.dataB,a.horaB,a.horaC)," ",botaoExcluirAluno(a.id,a.nome,a.equipamento,a.status,a.matricula,a.serial,a.dataA,a.horaA,a.dataB,a.horaB,a.horaC)," ",botaoVerificarAluno(a.id,a.nome,a.equipamento,a.status,a.matricula,a.serial,a.dataA,a.horaA,a.dataB,a.horaB,a.horaC))})}}
let botaoVizualizarAluno=function(id,nome,equipamento,status,matricula,serial,dataA,horaA,dataB,horaB,horaC){let ver=document.createElement("button");ver.className='btn btn-outline-info btn-sm';ver.title="Vizualizar";ver.innerHTML='<i class="fa fa-eye"></i>';ver.id=`id-ver-${id}`;ver.onclick=function(){modalVizualizar(nome,tabelaAlunoB("info",equipamento,cor(status),matricula,serial,dataBR(dataA),horaA,dataBR(dataB),horaB,horaC),"aluno")}
return ver}
let botaoVizualizarProfessor=function(id,nome,equipamento,status,sala,dataA,horaA,dataB,horaB,horaC,horaD){let ver=document.createElement("button");ver.className='btn btn-outline-info btn-sm';ver.title="Vizualizar";ver.innerHTML='<i class="far fa-eye"></i>';ver.id=`id-ver-${id}`;ver.onclick=function(){modalVizualizar(nome,tabelaProfessorB("info",equipamento,cor(status),sala,dataBR(dataA),horaA,dataBR(dataB),horaB,horaC,horaD),"professor")}
return ver}
let botaoEditarAluno=function(id,nome,equipamento,status,matricula,serial,dataA,horaA,dataB,horaB,horaC){let editar=document.createElement("button");editar.className='btn btn-outline-success btn-sm';editar.title="Editar";editar.innerHTML='<i class="fas fa-pencil-alt"></i>';editar.id=`id-editar-${id}`;editar.onclick=function(){if(dataA>=dataAtual()){if(horaAtual(0,5,0)<=horaA){if(status=="Aguardando"){let=resposta=prompt("Deseja EDITAR a reserva do(a) "+nome+"? R: Sim ou Não","Não");if(resposta=="sim"||resposta=="SIM"||resposta=="Sim"||resposta=="s"||resposta=="S"){let _nome=prompt("Nome do(a) Aluno(a):",nome);let _matricula=prompt("Matrícula:",matricula);let _equipamento=prompt("Descrição do equipamento:",equipamento);let _serial=prompt("Nº de série:",serial);let _dataA=prompt("Data:",dataBR(dataA));let _horaA=prompt("Hora:",horaA);reserva=new ReservaAluno(_nome,_equipamento,status,_matricula,_serial,dataEUA(_dataA),_horaA,dataB,horaB,horaC);if(reserva.validarDados()){let id=this.id.replace('id-editar-','');bancodedados.removerReserva(id);modalEditar(_nome,tabelaAlunoA("success",_equipamento,_matricula,_serial,_dataA,_horaA),"aluno");bancodedados.gravar(reserva,"Aluno")}
else{modalErro()}}}
else{modalEditarErro(nome,"aluno")}}
else{modalEditarErro(nome,"aluno")}}
else{modalEditarErro(nome,"aluno")}}
return editar}
let botaoEditarProfessor=function(id,nome,equipamento,status,sala,dataA,horaA,dataB,horaB,horaC,horaD){let editar=document.createElement("button");editar.className='btn btn-outline-success btn-sm';editar.title="Editar";editar.innerHTML='<i class="fas fa-pencil-alt"></i>';editar.id=`id-editar-${id}`;editar.onclick=function(){if(dataA>=dataAtual()){if(horaAtual(0,5,0)<=horaA){if(status=="Aguardando"){let=resposta=prompt("Deseja EDITAR a reserva do(a) "+nome+"? R: Sim ou Não","Não");if(resposta=="sim"||resposta=="SIM"||resposta=="Sim"||resposta=="s"||resposta=="S"){let _nome=prompt("Nome do(a) Professor(a):",nome);let _equipamento=prompt("Descrição do equipamento:",equipamento);let _sala=prompt("Nome da sala:",sala);let _horaA=prompt("Início da aula:",horaA);let _horaB=prompt("Término da aula:",horaB);let _dataA=prompt("Data da aula:",dataBR(dataA));let reserva=new ReservaProfessor(_nome,_equipamento,status,_sala,dataEUA(_dataA),_horaA,dataB,_horaB,horaC,horaD);if(reserva.validarDados()){let id=this.id.replace('id-editar-','');bancodedados.removerReserva(id);modalEditar(_nome,tabelaProfessorA("success",_equipamento,_sala,_dataA,_horaA,_horaB),"professor");bancodedados.gravar(reserva,"Professor")}
else{modalErro()}}}
else{modalEditarErro(nome,"professor")}}
else{modalEditarErro(nome,"professor")}}
else{modalEditarErro(nome,"professor")}}
return editar}
let botaoExcluirAluno=function(id,nome,equipamento,status,matricula,serial,dataA,horaA,dataB,horaB,horaC){excluir=document.createElement("button");excluir.className='btn btn-outline-danger btn-sm';excluir.title='Excluir';excluir.innerHTML='<i class="fa fa-trash-alt"></i>';excluir.id=`id-excluir-${id}`;excluir.onclick=function(){let resposta=prompt("Deseja EXCLUIR a reserva do(a) "+nome+"? R: Sim ou Não","Não");if(resposta=='sim'||resposta=='SIM'||resposta=='Sim'||resposta=='s'||resposta=='S'){let id=this.id.replace('id-excluir-','');bancodedados.removerReserva(id);modalExcluir(nome,tabelaAlunoB("danger",equipamento,cor(status),matricula,serial,dataBR(dataA),horaA,dataBR(dataB),horaB,horaC),"aluno")}}
return excluir}
let botaoExcluirProfessor=function(id,nome,equipamento,status,sala,dataA,horaA,dataB,horaB,horaC,horaD){excluir=document.createElement("button");excluir.className='btn btn-outline-danger btn-sm';excluir.title='Excluir';excluir.innerHTML='<i class="fa fa-trash-alt"></i>';excluir.id=`id-excluir-${id}`;excluir.onclick=function(){let resposta=prompt("Deseja EXCLUIR a reserva do(a) "+nome+"? R: Sim ou Não","Não");if(resposta=='sim'||resposta=='SIM'||resposta=='Sim'||resposta=='s'||resposta=='S'){let id=this.id.replace('id-excluir-','');bancodedados.removerReserva(id);modalExcluir(nome,tabelaProfessorB("danger",equipamento,cor(status),sala,dataBR(dataA),horaA,dataBR(dataB),horaB,horaC,horaD),"professor")}}
return excluir}
let botaoVerificarAluno=function(id,nome,equipamento,status,matricula,serial,dataA,horaA,dataB,horaB,horaC){verificar=document.createElement("button");verificar.className="btn btn-outline-primary btn-sm";verificar.title="Verificar";verificar.innerHTML='<i class="fas fa-user-check"></i>';verificar.id=`id-verifica-${id}`;verificar.onclick=function(){if(status=="Aguardando"){let resposta=prompt("A reserva do(a) "+nome+" está em uso? R: Sim ou Não","Não");if(resposta=='sim'||resposta=='SIM'||resposta=='Sim'||resposta=='s'||resposta=='S'){let _nome=nome;let _equipamento=equipamento;let _status="Em uso";let _matricula=matricula;let _serial=serial;let _dataA=dataA;let _horaA=horaA;let _dataB=dataAtual();let _horaB=horaAtual(0,0,0);let _horaC=horaC;reserva=new ReservaAluno(_nome,_equipamento,_status,_matricula,_serial,_dataA,_horaA,_dataB,_horaB,_horaC);if(reserva.validarDados()){let id=this.id.replace('id-verifica-','');bancodedados.removerReserva(id);modalVerificar(_nome,tabelaAlunoB("primary",_equipamento,cor(_status),_matricula,_serial,dataBR(_dataA),_horaA,dataBR(_dataB),_horaB,_horaC),"aluno",_status);bancodedados.gravar(reserva,"Aluno")}
else{modalErro()}}}
else if(status=="Em uso"){let resposta=prompt("A reserva do(a) "+nome+" está recolhida? R: Sim ou Não","Não");if(resposta=='sim'||resposta=='SIM'||resposta=='Sim'||resposta=='s'||resposta=='S'){let _nome=nome;let _equipamento=equipamento;let _status="Recolhida";let _matricula=matricula;let _serial=serial;let _dataA=dataA;let _horaA=horaA;let _dataB=dataAtual();let _horaB=horaB;let _horaC=horaAtual(0,0,0);reserva=new ReservaAluno(_nome,_equipamento,_status,_matricula,_serial,_dataA,_horaA,_dataB,_horaB,_horaC);if(reserva.validarDados()){let id=this.id.replace('id-verifica-','');bancodedados.removerReserva(id);modalVerificar(_nome,tabelaAlunoB("primary",_equipamento,cor(_status),_matricula,_serial,dataBR(_dataA),_horaA,dataBR(_dataB),_horaB,_horaC),"aluno",_status);bancodedados.gravar(reserva,"Aluno")}
else{modalErro()}}}
else{modalVerificarErro(nome,"aluno")}}
return verificar}
let botaoVerificarProfessor=function(id,nome,equipamento,status,sala,dataA,horaA,dataB,horaB,horaC,horaD){verificar=document.createElement("button");verificar.className="btn btn-outline-primary btn-sm";verificar.title="Verificar";verificar.innerHTML='<i class="fas fa-user-check"></i>';verificar.id=`id-verifica-${id}`;verificar.onclick=function(){if(status=="Aguardando"){let resposta=prompt("A reserva do(a) "+nome+" já está em uso? R: Sim ou Não","Não");if(resposta=='sim'||resposta=='SIM'||resposta=='Sim'||resposta=='s'||resposta=='S'){let _nome=nome;let _equipamento=equipamento;let _status="Em uso";let _sala=sala;let _dataA=dataA;let _horaA=horaA;let _horaB=horaB;let _dataB=dataAtual();let _horaC=horaAtual(0,0,0);let _horaD=horaD;reserva=new ReservaProfessor(_nome,_equipamento,_status,_sala,_dataA,_horaA,_dataB,_horaB,_horaC,_horaD);if(reserva.validarDados()){modalVerificar(_nome,tabelaProfessorB("primary",_equipamento,cor(_status),_sala,dataBR(_dataA),_horaA,dataBR(_dataB),_horaB,_horaC,_horaD),"professor",_status);let id=this.id.replace('id-verifica-','');bancodedados.removerReserva(id);bancodedados.gravar(reserva,"Professor")}
else{modalErro()}}}
else if(status=="Em uso"){let resposta=prompt("A reserva do(a) "+nome+" foi recolhida? R: Sim ou Não","Não");if(resposta=='sim'||resposta=='SIM'||resposta=='Sim'||resposta=='s'||resposta=='S'){let _nome=nome;let _equipamento=equipamento;let _status="Recolhida";let _sala=sala;let _dataA=dataA;let _horaA=horaA;let _horaB=horaB;let _dataB=dataB;let _horaC=horaC;let _horaD=horaAtual(0,0,0);reserva=new ReservaProfessor(_nome,_equipamento,_status,_sala,_dataA,_horaA,_dataB,_horaB,_horaC,_horaD);if(reserva.validarDados()){let id=this.id.replace('id-verifica-','');bancodedados.removerReserva(id);modalVerificar(_nome,tabelaProfessorB("primary",_equipamento,cor(_status),_sala,dataBR(_dataA),_horaA,dataBR(_dataB),_horaB,_horaC,_horaD),"professor",_status);bancodedados.gravar(reserva,"Professor")}
else{modalErro()}}}
else{modalVerificarErro(nome,"professor")}}
return verificar}
let alertaP=function(){setInterval(alertarReservaP,30000)}
function alertarReservaP(){reservas=bancodedados.recuperaReservaProfessor();reservas.forEach(function(p){if(p.dataA==dataAtual()){if(p.status=="Aguardando"){if(horaAtualB(0,0)>=p.horaA){modalAlertarReserva(p.nome,tabelaProfessorB("warning",p.equipamento,cor(p.status),p.sala,dataBR(p.dataA),p.horaA,dataBR(dataAtual()),p.horaB,horaAtual(0,0,0),p.horaD),"professor","iniciar")}}
if(p.status=="Em uso"){if(horaAtualB(0,0)>=p.horaB){modalAlertarReserva(p.nome,tabelaProfessorB("warning",p.equipamento,cor(p.status),p.sala,dataBR(p.dataA),p.horaA,dataBR(p.dataB),p.horaB,p.horaC,horaAtual(0,0,0)),"professor","acabar")}}}})}
let alertaA=function(){setInterval(alertarReservaA,30000)}
function alertarReservaA(){reservas=bancodedados.recuperaReservaAluno();reservas.forEach(function(a){if(a.dataA==dataAtual()){if(a.status=="Aguardando"){if(horaAtualB(0,0)>=a.horaA){modalAlertarReserva(a.nome,tabelaAlunoB("warning",a.equipamento,cor(a.status),a.matricula,a.serial,dataBR(a.dataA),a.horaA,dataBR(a.dataB),a.horaB,a.horaC),"aluno","iniciar")}}}})}
let tabelaProfessorA=function(bg,equipamento,sala,dataA,horaA,horaB){let tabela='<br><br><table class="table table-bordered text-center"><thead><tr class="text-center bg-'+bg+'"><th scope="col" class="text-white"><i class="fas fa-desktop" title="Equipamento"></i></th><th scope="col" class="text-white"><i class="fas fa-compass" title="Local"></i></th><th scope="col" class="text-white"><i class="fas fa-user-clock" title="Horário da reserva"></i></th></tr></thead><tbody><tr><td>'+equipamento+'</td><td>'+sala+'</td><td>'+dataA+'<br>'+horaA+' / '+horaB+'</td></tr></tbody></table>';return tabela}
let tabelaAlunoA=function(bg,equipamento,matricula,serial,dataA,horaA){let tabela='<br><br><table class="table table-bordered text-center"><thead><tr class="text-center bg-'+bg+'"><th scope="col" class="text-white"><i class="fas fa-address-card" title="Matrícula"></i></th><th scope="col" class="text-white"><i class="fas fa-laptop" title="Equipamento"></i></th><th scope="col" class="text-white"><i class="fas fa-barcode" title="Nº de série"></i></th><th scope="col" class="text-white"><i class="fas fa-user-clock" title="Data e hora"></i></i></th></tr></thead><tbody><tr><th class="font-weight-normal">'+matricula+'</th><td>'+equipamento+'</td><td>'+serial+'</td><td>'+dataA+'<br>'+horaA+'</td></tr></tbody></table>';return tabela}
let tabelaProfessorB=function(bg,equipamento,status,sala,dataA,horaA,dataB,horaB,horaC,horaD){let tabela='<br><br><table class="table table-bordered text-center"><thead><tr class="text-center bg-'+bg+'"><th scope="col" class="text-white"><i class="fas fa-desktop" title="Equipamento"></i></th><th scope="col" class="text-white"><i class="fas fa-compass" title="Local"></i></th><th scope="col" class="text-white"><i class="fas fa-user-clock" title="Horário da reserva"></i></th><th scope="col" class="text-white"><i class="fas fa-user-clock" title="Horário final"></i></th><th class="text-white" title="Status"><i class="fas fa-clipboard-check" title="Status"></i></th></tr></thead><tbody><tr><td>'+equipamento+'</td><td>'+sala+'</td><td>'+dataA+'<br>'+horaA+' / '+horaB+'</td><td>'+dataB+'<br>'+horaC+' / '+horaD+'</td><td>'+status+'</td></tr></tbody></table>';return tabela}
let tabelaAlunoB=function(bg,equipamento,status,matricula,serial,dataA,horaA,dataB,horaB,horaC){let tabela='<br><br><table class="table table-bordered text-center"><thead><tr class="text-center bg-'+bg+'"><th scope="col" class="text-white"><i class="fas fa-address-card" title="Matrícula"></i></th><th scope="col" class="text-white"><i class="fas fa-laptop" title="Equipamento"></i></th><th scope="col" class="text-white"><i class="fas fa-barcode" title="Nº de série"></i></th><th scope="col" class="text-white"><i class="fas fa-user-clock" title="Horário da reserva"></i></th><th scope="col" class="text-white"><i class="fas fa-user-clock" title="Horário final"></i></th><th class="text-white" title="Status"><i class="fas fa-clipboard-check" title="Status"></i></th></tr></thead><tbody><tr><td>'+matricula+'</td><td>'+equipamento+'</td><td>'+serial+'</td><td>'+dataA+'<br>'+horaA+'</td><td>'+dataB+'<br>'+horaB+' / '+horaC+'</td><td>'+status+'</td></tr></tbody></table>';return tabela}
let tabelaApp=function(nome,versao,dataA,horaA){let tabela='<br><br><table class="table table-bordered text-center"><thead><tr class="text-center bg-info"><th scope="col" class="text-white"><i class="fas fa-user-circle" title="Funcionário"></i></th><th scope="col" class="text-white"><i class="fas fa-user-tag" title="Versão"></i></th><th scope="col" class="text-white"><i class="fas fa-user-clock" title="Cadastro"></th><th scope="col" class="text-white"><i class="fab fa-github" title="GitHub"></i></th></tr></thead><tbody><tr><td>'+nome+'</td><td>'+versao+'</td><td>'+dataA+'<br>'+horaA+'</td><td><b><a href="https://github.com/JefersonLucas/reserve" target="_blank" title="Projeto">GitHub</a></b></td></tr></tbody></table>';return tabela}
let cor=function(status){let cor=null;if(status=="Aguardando"){cor='<span class="text-danger"><b>'+status+'</b></span>'}
else if(status=="Em uso"){cor='<span class="text-success"><b>'+status+'</b></span>'}
else{cor='<span class="text-primary"><b>'+status+'</b></span>'}
return cor}
let dataBR=function(dataEUA){let diaBR=dataEUA.substr(8,2);let mesBR="/"+dataEUA.substr(5,2);let anoBR="/"+dataEUA.substr(0,4);let dataBR=diaBR+mesBR+anoBR;return dataBR}
let dataEUA=function(dataBR){let diaEUA=dataBR.substr(6,4);let mesEUA="-"+dataBR.substr(3,2);let anoEUA="-"+dataBR.substr(0,2);let dataEUA=diaEUA+mesEUA+anoEUA;return dataEUA}
let relogio=function(){setInterval(calendario,100)}
