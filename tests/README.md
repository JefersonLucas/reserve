...
| (v1.5.0-beta) **new** | ##/07/2018 | Todas as funcionalidades em uma única página; Mudança da aparência dos inputs; Mudança na paleta de cores dos modais e botões; Mudança de ícones de botões; Nova página Aluno; |
