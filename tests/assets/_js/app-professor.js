...
//
	...
	//	MÉTODO PESQUISA E FILTRA OS DADOS DA RESERVA
		...
		//	FILTRO INICIO
			if(reserva.horaA != "") {
				reservasFiltradas = reservasFiltradas.filter(r => r.horaA == reserva.horaA);
			}
		//	FILTRO FIM
			if(reserva.horaB != "") {
				reservasFiltradas = reservasFiltradas.filter(r => r.horaB == reserva.horaB);
			}
		//	FILTRO DIA
			if(reserva.dataEUA != "") {
				reservasFiltradas = reservasFiltradas.filter(r => r.dataEUA == reserva.dataEUA);
			}
		//	RETORVA O FILTRO
